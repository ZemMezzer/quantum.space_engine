...
{
    [CreateAssetMenu(
        fileName = "Spiral Galaxy Generator",
        menuName = "Space Engine/Stellar Objects/Galaxies/Generators/Spiral")]
    public sealed class SpiralGalaxyGenerator : ProceduralGalaxyGenerator
    {
        protected override float RelativeWeight => 0.58f;
        ...
        protected override double3 GenerateShapeLocalPosition(
            ...
            ref QuantumRandom random)
        {
            return GenerateDiskPosition(galaxy, ref random);
        }
